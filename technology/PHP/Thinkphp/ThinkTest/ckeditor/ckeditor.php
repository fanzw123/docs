...
if ( !function_exists('version_compare') || version_compare( phpversion(), '5', '<' ) )
	include_once( '../../ThinkTest/ckeditor/ckeditor_php4.phpinkT../../Thinkphp/ThinkTest/ckeditor_php5.php.php' ) ../../ThinkTest/ckeditor/ckeditor_php5.php_once( 'ckeditor_php5.php' ) ;
