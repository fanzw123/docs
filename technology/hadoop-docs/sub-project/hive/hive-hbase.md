...
1. 单节点模式启动
  ...
  --hiveconf hbase.master=uhadoop-ociicy-master1:60000


2. 集群模式启动 (优先使用 Hbase 中的包)
  hive --auxpath \ $HIVE_HOME/lib/hive-hbase-handler-1.1.0-cdh5.4.4.jar,$HBASE_HOME/lib/hbase-common-1.0.0-cdh5.4.4.jar,$HBASE_HOME/lib/zookeeper-3.4.5-cdh5.4.4.jar,$HBASE_HOME/lib/guava-12.0.1.jar \
  --hiveconf hbase.zookeeper.quorum=uhadoop-ociicy-master1,uhadoop-ociicy-master2
...
3. 永远生效环境配置 (HIVE_AUX_JARS_PATH 和 hive.aux.jars.path 会互相覆盖)
  ...
  <property>
   ...
   ucloud
   file:///home/hadoop/hive/lib/hive-hbase-handler-1.1.0-cdh5.4.4.jar,file:///home/hadoop/hbase/lib/hbase-common-1.0.0-cdh5.4.4.jar,file:///home/hadoop/hbase/lib/zookeeper-3.4.5-cdh5.4.4.jar,file:///home/hadoop/hbase/lib/guava-12.0.1.jar
