$(function(){
	...
	var $window = $(window),
		...
		speed = 250;
	$body.append("<div  id=\"pageLoad\" style=\"width:"+ docWidth +"px;height:"+ docHeight +"px;\"><div style=\"left:"+ (winWidth-350)*0.5 +"px;top:"+ (winHeight-150)*0.5 +"px;\"><b></b><samp><em></em></samp><span>0</span><p></p></div></div>");
