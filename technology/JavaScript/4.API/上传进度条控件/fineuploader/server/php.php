...
//这个文件用来处理不同的数据库格式
用来分别处理XMLHttpRequest、FormPost、BasicPost方式文件服务器端处理.在文件顶部注释中:
...
class qqFileUploader {
     ...
     * @param int $sizeLimit; defaults to the server's upload_max_filesize setting	//缺省为服务器的upload_max_filesize设置
     */
    ...
    /**
     * Internal function that checks if server's may sizes match the	//内部功能检查服务器的可能大小匹配
     * object's maximum size for uploads		//用于上传的对象的最大尺寸
     */
    ...
    /**
     * Convert a given size with units to bytes		//将一个单位给定大小的字节
     * @param string $str
     */
    ...
    /**
     * Handle the uploaded file		//处理上传的文件
