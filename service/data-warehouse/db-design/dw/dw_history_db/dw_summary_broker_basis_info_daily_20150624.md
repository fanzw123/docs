...
### 1、备份源数据库
``` sql
./migrate-hive-tabel.sh source_table=dw_db.dw_summary_broker_basis_info_daily target_table=dw_db.dw_summary_broker_basis_info_daily_20150618
...
MYSQL
  ...
  ADD
    broker_duty_status_id varchar(255) NOT NULL DEFAULT '' AFTER broker_pv_home_day,
  ADD
    broker_city_id varchar(255) NOT NULL DEFAULT '' AFTER broker_duty_status_id,
  ADD
    agent_id varchar(255) NOT NULL DEFAULT '' AFTER broker_city_id,
  ADD
    company_id varchar(255) NOT NULL DEFAULT '' AFTER agent_id  
;
