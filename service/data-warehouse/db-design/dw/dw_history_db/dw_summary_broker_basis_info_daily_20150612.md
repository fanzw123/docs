...
-- 写入结果
DROP TABLE IF EXISTS dw_temp_angejia.dw_broker_summary_incoming_telegram;
...
CREATE TABLE dw_db.dw_summary_broker_basis_info_daily_20150609 LIKE dw_db.dw_summary_broker_basis_info_daily;

INSERT OVERWRITE TABLE
  dw_db.dw_summary_broker_basis_info_daily_20150609
PARTITION (
  p_dt
)
SELECT
...
MYSQL
  ALTER TABLE
    dw_db.dw_summary_broker_basis_info_daily
  ADD broker_laidian_num varchar(255) DEFAULT NULL,
  ADD broker_laidian_genjin_rate varchar(255) DEFAULT NULL;
