...
CREATE TABLE `dw_member_summary_detail_info_daily` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
  `member_id` varchar(100) NOT NULL DEFAULT '',
  `member_source_id` varchar(255) NOT NULL DEFAULT '',
  `member_source_name` varchar(255) NOT NULL DEFAULT '',
  `member_created_at` varchar(255) NOT NULL DEFAULT '',
  `member_phone` varchar(255) NOT NULL DEFAULT '',
  `member_web_guid` varchar(255) NOT NULL DEFAULT '',
  `member_web_brower_type` varchar(255) NOT NULL DEFAULT '',
  `member_web_os_type` varchar(255) NOT NULL DEFAULT '',
  `member_web_os_version` varchar(255) NOT NULL DEFAULT '',
  `member_commission_intraday` varchar(255) NOT NULL DEFAULT '',
  `member_commission_history` varchar(255) NOT NULL DEFAULT '',
  `member_device_ids` varchar(255) NOT NULL DEFAULT '',
  `member_device_type` varchar(255) NOT NULL DEFAULT '',
  `member_app_name` varchar(255) NOT NULL DEFAULT '',
  `member_device_platform` varchar(255) NOT NULL DEFAULT '',
  `member_device_os_version` varchar(255) NOT NULL DEFAULT '',
  `member_app_version` varchar(255) NOT NULL DEFAULT '',
  `member_app_channels_code` varchar(255) NOT NULL DEFAULT '',
  `member_app_channel_name` varchar(255) NOT NULL DEFAULT '',
  `member_inventory_collect_intraday` varchar(255) NOT NULL DEFAULT '',
  `member_inventory_collect_history` varchar(255) NOT NULL DEFAULT '',
  `member_pv_web_day` varchar(255) NOT NULL DEFAULT '',
  `member_pv_pc_inventory_list_day` varchar(255) NOT NULL DEFAULT '',
  `member_pv_pc_inventory_page_day` varchar(255) NOT NULL DEFAULT '',
  `member_pv_tw_inventory_list_day` varchar(255) NOT NULL DEFAULT '',
  `member_pv_tw_inventory_page_day` varchar(255) NOT NULL DEFAULT '',
  `member_pv_tw_community_page_day` varchar(255) NOT NULL DEFAULT '',
  `member_web_requset_first_time` varchar(255) NOT NULL DEFAULT '',
  `member_web_requset_last_time` varchar(255) NOT NULL DEFAULT '',
  `member_pv_app_api_day` varchar(255) NOT NULL DEFAULT '',
  `member_pv_app_inventory_list_day` varchar(255) NOT NULL DEFAULT '',
  `member_pv_app_inventory_page_day` varchar(255) NOT NULL DEFAULT '',
  `member_pv_app_community_page_day` varchar(255) NOT NULL DEFAULT '',
  `member_app_requset_first_time` varchar(255) NOT NULL DEFAULT '',
  `member_app_requset_last_time` varchar(255) NOT NULL DEFAULT '',
  `member_basic_demand_location` varchar(255) NOT NULL DEFAULT '',
  `member_basic_demand_house_type` varchar(255) NOT NULL DEFAULT '',
  `member_basic_demand_budget` varchar(255) NOT NULL DEFAULT '',
  `member_dislike_tag` varchar(255) NOT NULL DEFAULT '',
  `member_like_tag` varchar(255) NOT NULL DEFAULT '',
  `member_tel_m2b_all` varchar(255) NOT NULL DEFAULT '',
  `member_tel_m2b_distinct` varchar(255) NOT NULL DEFAULT '',
  `member_visit_sponsor_intraday` varchar(255) NOT NULL DEFAULT '',
  `member_visit_sponsor_history` varchar(255) NOT NULL DEFAULT '',
  `member_visit_real_intraday` varchar(255) NOT NULL DEFAULT '',
  `member_visit_real_history` varchar(255) NOT NULL DEFAULT '',
  `member_web_from_entrance` varchar(255) NOT NULL DEFAULT '',
  `member_wechat_message_m2b_distinct` varchar(255) NOT NULL DEFAULT '',
  `member_wechat_message_m2b_all` varchar(255) NOT NULL DEFAULT '',
  `p_dt` varchar(255) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`),
  KEY `idx_member_id` (`member_id`(10)),
  KEY `idx_p_dt` (`p_dt`(10))
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户日宽表';
```
