...
call_jt_and_wjt string comment '接通和未接通数',
call_jt string comment '接通时长大于0数',
...
HIVE
  ...
  ./migrate-hive-tabel.sh source_table=dw_db.dw_summary_broker_basis_info_daily target_table=dw_db.dw_summary_broker_basis_info_daily_20150629

MYSQL
  USE dw_db;
  CREATE TABLE
    dw_summary_broker_basis_info_daily_20150629
  LIKE
...
MYSQL
  ...
  ALTER TABLE
    dw_summary_broker_basis_info_daily
  ADD
    followup_fygjl_qc varchar(255) NOT NULL DEFAULT '' AFTER agent_type_name COMMENT '20150629 jason add';
```
