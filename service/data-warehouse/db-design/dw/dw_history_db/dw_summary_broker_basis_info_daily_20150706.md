...
``` sql
HIVE
  ./migrate-hive-tabel.sh source_table=dw_db.dw_summary_broker_basis_info_daily target_table=dw_db.dw_summary_broker_basis_info_daily_20150701

MYSQL
  USE dw_db;
  CREATE TABLE
    dw_summary_broker_basis_info_daily_20150701
  LIKE
...
HIVE
  ALTER TABLE
    dw_db.dw_summary_broker_basis_info_daily
  ADD COLUMNS(
    followup_fdgjl_distinct STRING COMMENT '20150701 jason add',
    followup_khgjl_distinct STRING COMMENT '20150701 jason add',
    broker_evaluate_day STRING COMMENT '20150701 jason add',
    broker_evaluate_distinct_day STRING COMMENT '20150701 jason add'
  );
...
MYSQL
  ...
  ALTER TABLE
    dw_summary_broker_basis_info_daily
  ADD
    followup_fdgjl_distinct varchar(255) NOT NULL DEFAULT '' AFTER followup_fygjl_qc,  
  ADD
    followup_khgjl_distinct varchar(255) NOT NULL DEFAULT '' AFTER followup_fdgjl_distinct,
  ADD
    broker_evaluate_day varchar(255) NOT NULL DEFAULT '' AFTER followup_khgjl_distinct,
  ADD
    broker_evaluate_distinct_day varchar(255) NOT NULL DEFAULT '' AFTER broker_evaluate_day
  ;
```
