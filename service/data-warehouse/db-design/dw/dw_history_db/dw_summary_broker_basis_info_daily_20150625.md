...
### 1、备份源数据库
``` sql
./migrate-hive-tabel.sh source_table=dw_db.dw_summary_broker_basis_info_daily target_table=dw_db.dw_summary_broker_basis_info_daily_20150624
...
MYSQL
  ...
  ADD
    agent_type_id varchar(255) NOT NULL DEFAULT '' AFTER company_id,
  ADD
    agent_type_name varchar(255) NOT NULL DEFAULT '' AFTER agent_type_id
;
