# da_broker_summary_basis_info_daily 提供给业务使用的经济人日表
...
INSERT OVERWRITE TABLE
  dw_temp_angejia.jason_da_broker_summary_basis_info_daily
PARTITION (
  p_dt = ${dealDate}
)
SELECT
...
-- 导出到 mysql 供业务拉取
export hive dw_temp_angejia.jason_da_broker_summary_basis_info_daily
